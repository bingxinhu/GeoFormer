...
class GeoFormer():
    ...
    def match_pairs(self, im1_path, im2_path, cpu=False, is_draw=False, npy_file=None, output_file=None):
        ...
        threshold = 0.64  # Adjust based on your needs
...
g.match_pairs('/media/HDD1/dual_modality_datasets/24_01_28/output_03/raw_frame/000334.png', '/media/HDD1/dual_modality_datasets/24_01_28/output_03/ImageRecons/reconstruction/frame_0000000333.png', is_draw=True, npy_file='/media/HDD1/dual_modality_datasets/24_01_28/output_03/time_split/000333.npy', output_file="mapped_image.jpg")
